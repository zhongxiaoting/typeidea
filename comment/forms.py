...
class CommentForm(forms.ModelForm):
    ...
    website = forms.URLField(label='网站', max_length=50,
                             widget=forms.widgets.URLInput(attrs={'class': 'form-control', 'style': 'width: 60%'}))
    content = forms.CharField(label="内容", max_length=500, widget=forms.widgets.Textarea(attrs={'row': 6, 'col': 60,
                                                                                               'class': 'form-control'}))
